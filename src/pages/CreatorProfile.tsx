...
import { Star, Instagram, Youtube, MapPin, Calendar, DollarSign, CheckCircle, Users, Camera, TrendingUp } from "lucide-react";
          ...
          <div className="container mx-auto px-4">
            <div className="max-w-6xl mx-auto">
              <div className="grid lg:grid-cols-2 gap-12">
                {/* Services */}
                <div>
                  <h2 className="text-3xl font-bold mb-6">Services & Pricing</h2>
